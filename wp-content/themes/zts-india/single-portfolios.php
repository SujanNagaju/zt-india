        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="image-block">
                    <img src="<?php echo home_url(); ?>/wp-content/uploads/2022/05/thelivingurn.jpg" alt="">
                </div><!-- image-block -->
            </div><!-- col-lg-5 -->
            <div class="col-lg-7">
                <div class="info-right">
                    <h1>The Living Urn</h1>
                    <ul>
                        <li>Client: <span>Ricardo J. Bowen</span></li>
                        <li>Date: <span>20 August, 2022</span></li>
                        <li>Category: <span>Web Development, UI/UX Design</span></li>
                    </ul>
                </div><!-- info-right -->
            </div><!-- col-lg-7 -->
        </div><!-- row -->
